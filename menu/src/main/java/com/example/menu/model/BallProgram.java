...
import com.example.menu.util.ShaderUtil;
...
public class BallProgram {
    ...
    private String mVertexShader =
            "uniform mat4 uMVPMatrix; //总变换矩阵\n" +
                    ...
                    "   pointLight(normalize(aNormal),vambient,vdiffuse,vspecular,vec3(-80.0,0.0,100.0),vec4(0.3,0.3,0.3,1.0),vec4(0.7,0.7,0.7,1.0),vec4(0.3,0.3,0.3,1.0));\n" +
